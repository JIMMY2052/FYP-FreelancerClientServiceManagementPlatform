-- Execute this SQL script to create the necessary tables for work submission feature
...
-- Check and update agreement table status enum to include 'pending_review'
-- First, check if the column exists and what its current definition is
SELECT COLUMN_TYPE 
...
-- If needed, manually run this ALTER statement after checking:
-- ALTER TABLE agreement MODIFY COLUMN Status ENUM('to_accept', 'ongoing', 'pending_review', 'completed', 'cancelled') DEFAULT 'to_accept';
