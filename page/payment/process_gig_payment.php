...
try {
    ...
    $stmt = $conn->prepare($sql);
    $stmt->bind_param('iissssdssssssi', 
        $freelancerId, $clientId, $clientName, $freelancerName, $projectTitle, 
        $projectDetail, $totalAmount, $status, $clientSignedDate, $expiredDate, 
        $terms, $scope, $deliverables, $deliveryTime
    );
